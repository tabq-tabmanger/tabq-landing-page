...
import { BugIcon, LucideIcon, ZapIcon } from "lucide-react";
            ...
            <AnimationContainer reverse delay={0.1} className="size-full">
                <MaxWidthWrapper className="flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center gap-x-4">
                        ...
                        <Link href="https://chromewebstore.google.com/detail/tabq-tab-manager/bbackfjoenepphijbngcjlafamkenbef" className={buttonVariants({ size: "sm", })} target="_blank" rel="noopener noreferrer">
                            Get Started
