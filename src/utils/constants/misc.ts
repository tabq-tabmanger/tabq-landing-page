import { DownloadIcon, FolderOpenIcon, LayoutGridIcon } from "lucide-react";
...
export const PROCESS = [
    {
        title: "Install TabQ",
        description: "Add TabQ to your browser from the Chrome Web Store with one click.",
        icon: DownloadIcon,
    },
    {
        title: "Create Workspaces",
        description: "Organize your tabs into workspaces for Work, Personal, Study, and more.",
        icon: LayoutGridIcon,
    },
    {
        title: "Start Organizing",
        description: "Add your favorite sites and collections. Your data stays on your device.",
        icon: FolderOpenIcon,
    },
] as const;
